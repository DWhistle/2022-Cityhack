...
func (x *DomainData) GetUrl() string {
	if x != nil {
		return x.Url
	}
	return ""
...
func (x *DomainData) GetEmail() string {
	if x != nil {
		return x.Email
	}
	return ""
...
func (x *DomainData) GetPhone() string {
	if x != nil {
		return x.Phone
	}
	return ""
...
var file_proto_domain_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x05, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x4a, 0x0a, 0x0a, 0x44,
	0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x44, 0x61, 0x74, 0x61, 0x12, 0x10, 0x0a, 0x03, 0x75, 0x72, 0x6c,
	...
	0x52, 0x05, 0x70, 0x68, 0x6f, 0x6e, 0x65, 0x42, 0x0a, 0x5a, 0x08, 0x2e, 0x2f, 0x6d, 0x6f, 0x64,
...
var file_proto_domain_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_proto_domain_proto_goTypes = []interface{}{
	(*DomainData)(nil), // 0: proto.DomainData
}
